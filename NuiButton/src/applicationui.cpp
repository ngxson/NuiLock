...
void ApplicationUI::onSystemLanguageChanged()
{
    ...
    QString file_name = QString("NuiButton_%1").arg(locale_string);
...
void ApplicationUI::resendNotification()
{
    ...
    request.setTarget("com.example.NuiButtonService");
    request.setAction("com.example.NuiButtonService.RESET");
